        ...
        <div class="container mx-auto">
            ...
            <div class="mx-atuo">
                <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                        ...
                        @if (session()->has('message'))
                            <div
                                ...
                                <div
                                    ...
                                    <div class="text-sm font-medium ml-3">Success Delete.</div>
                                </div>
                                <div
                                    class="text-sm tracking-wide text-gray-500 mt-4 sm:mt-0 sm:ml-4">{{ session('message') }}</div>
                                <div
                    ...
                    <div><input class="form-input w-32 sm:w-64 rounded-md pl-10 pr-4 focus:border-indigo-600"
                                type="text" placeholder="Search" wire:model="searchTerm">
                    </div>
                    <div class="p-2 flex-no-wrap">
                        <button wire:click="create()"
                                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Create
                            New
                            Post
                        </button>
                    ...
                    <div
                        class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200" wire:init="loadContacts">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div
                                                    class="text-sm leading-5 font-medium text-gray-900">{{$customer->name}}
                                                </div>
                                                <div class="text-sm leading-5 text-gray-500">{{$customer->ceo}}</div>
                                            </div>
                                        </div>
                                    </td>

                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                        <div class="text-sm leading-5 text-gray-900">{{$customer->tel}}</div>
                                        <div class="text-sm leading-5 text-gray-500">{{$customer->site}}</div>
                                    </td>

                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                        <span
                                            class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">{{$customer->status==1 ?"Active":"Disabled"}}</span>
                                    </td>
